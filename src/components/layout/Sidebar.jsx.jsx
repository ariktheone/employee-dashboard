    ...
    <>
      ...
      >
        ...
        <div className="p-4 bg-white/90 border-t border-blue-100 flex-shrink-0">
          <div className="flex items-center space-x-3 p-3 rounded-xl bg-gradient-to-r from-blue-100 to-indigo-100 hover:from-blue-200 hover:to-indigo-200 transition-colors cursor-pointer mb-3 shadow">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-semibold text-blue-900 truncate">Admin User</p>
              <p className="text-xs text-blue-500 truncate">admin@company.com</p>
            </div>
          </div>
          <button className="w-full flex items-center justify-center px-4 py-2.5 text-red-600 hover:text-white hover:bg-gradient-to-r hover:from-red-500 hover:to-pink-500 text-sm font-medium rounded-xl transition-all duration-200 shadow">
